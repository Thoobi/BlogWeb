        ...
        <>
            <section className='h-120 w-full bg-stone-100 flex flex-row justify-between items-center gap-25 font-sans'>
                <div className='w-6/12 flex flex-col justify-center items-center mx-auto'>
                    ...
                    <h4 className='text-2xl text-slate-600 font-medium'>Why learn how to blog?</h4>
                </div>
            ...
            <section className='flex flex-row justify-between items-center w-4/5 h-1/5 mx-auto my-8 border rounded-lg border-gray-300 p-0'>
                <div className='w-2/4 h-full p-10 flex flex-col justify-start items-start'>
            ...
            <section className='flex flex-row justify-between items-center w-4/5 mx-auto my-10'>
                ...
                <div className='bg-stone-100 w-30 h-100 p-3 shadow-lg rounded-lg hover:border hover:border-slate-100 hover:rounded-lg'>
                    ...
                    <div className='flex flex-row justify-between items-center h-5 w-full mt-5'>
                        ...
                        <Link to='/articles' className='text-md font-medium text-black text-white bg-black w-32 py-2 px-2 rounded-full text-center hover:bg-inherit hover:border hover:border-black hover:text-black'>Read more...</Link>
                    </div>
                </div>
            ...
            <section className='flex flex-row justify-between items-center w-4/5 h-200 mx-auto my-5'>
                <div className='flex flex-col w-3/6 bg-slate-200 h-full px-10 gap-9 pt-20'>
                    <h1 className='text-5xl font-black min-w-96 px-10'>
                        What is Lorem Ipsum?
                    </h1>
                    <p className='text-lg px-10 min-w-64 font-medium text-slate-600'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution...</p>
